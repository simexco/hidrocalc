...
export const PIPE_CATALOG: PipeCatalogGroup[] = [
  ...
  },
  {
    ...
    sizes: [
      { label: "OD 63 (2in)", od: 63, classes: [{ name: "SDR 26", e: 2.5 }, { name: "SDR 17", e: 3.8 }, { name: "SDR 13.6", e: 4.7 }] },
      { label: "OD 75 (2.5in)", od: 75, classes: [{ name: "SDR 26", e: 3.0 }, { name: "SDR 17", e: 4.5 }, { name: "SDR 13.6", e: 5.6 }] },
      { label: "OD 90 (3in)", od: 90, classes: [{ name: "SDR 26", e: 3.5 }, { name: "SDR 17", e: 5.4 }, { name: "SDR 13.6", e: 6.7 }] },
      { label: "OD 110 (4in)", od: 110, classes: [{ name: "SDR 26", e: 4.3 }, { name: "SDR 17", e: 6.6 }, { name: "SDR 13.6", e: 8.1 }] },
      { label: "OD 160 (6in)", od: 160, classes: [{ name: "SDR 26", e: 6.2 }, { name: "SDR 17", e: 9.5 }, { name: "SDR 13.6", e: 11.8 }] },
      { label: "OD 200 (8in)", od: 200, classes: [{ name: "SDR 26", e: 7.7 }, { name: "SDR 17", e: 11.9 }, { name: "SDR 13.6", e: 14.8 }] },
      { label: "OD 250 (10in)", od: 250, classes: [{ name: "SDR 26", e: 9.7 }, { name: "SDR 17", e: 14.8 }, { name: "SDR 13.6", e: 18.5 }] },
      { label: "OD 315 (12in)", od: 315, classes: [{ name: "SDR 26", e: 12.2 }, { name: "SDR 17", e: 18.7 }, { name: "SDR 13.6", e: 23.2 }] },
      { label: "OD 400 (16in)", od: 400, classes: [{ name: "SDR 26", e: 15.4 }, { name: "SDR 17", e: 23.5 }, { name: "SDR 13.6", e: 29.4 }] },
      { label: "OD 500 (20in)", od: 500, classes: [{ name: "SDR 26", e: 19.2 }, { name: "SDR 17", e: 29.4 }, { name: "SDR 13.6", e: 36.8 }] },
      { label: "OD 630 (24in)", od: 630, classes: [{ name: "SDR 26", e: 24.2 }, { name: "SDR 17", e: 37.1 }, { name: "SDR 13.6", e: 46.3 }] },
    ],
  },
  {
    ...
    sizes: [
      ...
      { label: '3"', od: 88.9, classes: [{ name: "SDR 41", e: 2.2 }, { name: "SDR 26", e: 3.4 }, { name: "SDR 17", e: 5.2 }] },
      ...
      { label: '10"', od: 273.0, classes: [{ name: "SDR 41", e: 6.7 }, { name: "SDR 26", e: 10.5 }, { name: "SDR 17", e: 16.1 }] },
      { label: '12"', od: 323.9, classes: [{ name: "SDR 41", e: 7.9 }, { name: "SDR 26", e: 12.5 }, { name: "SDR 17", e: 19.1 }] },
      { label: '14"', od: 355.6, classes: [{ name: "SDR 41", e: 8.7 }, { name: "SDR 26", e: 13.7 }, { name: "SDR 17", e: 20.9 }] },
      { label: '16"', od: 406.4, classes: [{ name: "SDR 41", e: 9.9 }, { name: "SDR 26", e: 15.6 }, { name: "SDR 17", e: 23.9 }] },
      { label: '18"', od: 457.2, classes: [{ name: "SDR 41", e: 11.1 }, { name: "SDR 26", e: 17.6 }, { name: "SDR 17", e: 26.9 }] },
      { label: '20"', od: 508.0, classes: [{ name: "SDR 41", e: 12.4 }, { name: "SDR 26", e: 19.5 }, { name: "SDR 17", e: 29.9 }] },
      { label: '24"', od: 609.6, classes: [{ name: "SDR 41", e: 14.9 }, { name: "SDR 26", e: 23.4 }, { name: "SDR 17", e: 35.9 }] },
    ],
  },
  {
    material: "HDPE", E: 1e9, label: "HDPE — ISO 4427 PE100",
    sizes: [
      { label: "OD 63 (2in)", od: 63, classes: [{ name: "SDR 17", e: 3.8 }, { name: "SDR 11", e: 5.8 }] },
      { label: "OD 75 (2.5in)", od: 75, classes: [{ name: "SDR 17", e: 4.5 }, { name: "SDR 11", e: 6.8 }] },
      { label: "OD 90 (3in)", od: 90, classes: [{ name: "SDR 17", e: 5.4 }, { name: "SDR 11", e: 8.2 }] },
      { label: "OD 110 (4in)", od: 110, classes: [{ name: "SDR 17", e: 6.6 }, { name: "SDR 11", e: 10.0 }] },
      { label: "OD 160 (6in)", od: 160, classes: [{ name: "SDR 17", e: 9.5 }, { name: "SDR 11", e: 14.6 }] },
      { label: "OD 200 (8in)", od: 200, classes: [{ name: "SDR 17", e: 11.9 }, { name: "SDR 11", e: 18.2 }] },
      { label: "OD 250 (10in)", od: 250, classes: [{ name: "SDR 17", e: 14.8 }, { name: "SDR 11", e: 22.7 }] },
      { label: "OD 315 (12in)", od: 315, classes: [{ name: "SDR 17", e: 18.7 }, { name: "SDR 11", e: 28.6 }] },
      { label: "OD 355 (14in)", od: 355, classes: [{ name: "SDR 17", e: 20.9 }, { name: "SDR 11", e: 32.3 }] },
      { label: "OD 400 (16in)", od: 400, classes: [{ name: "SDR 17", e: 23.7 }, { name: "SDR 11", e: 36.4 }] },
      { label: "OD 450 (18in)", od: 450, classes: [{ name: "SDR 17", e: 26.5 }, { name: "SDR 11", e: 40.9 }] },
      { label: "OD 500 (20in)", od: 500, classes: [{ name: "SDR 17", e: 29.4 }, { name: "SDR 11", e: 45.5 }] },
      { label: "OD 630 (24in)", od: 630, classes: [{ name: "SDR 17", e: 37.1 }, { name: "SDR 11", e: 57.3 }] },
    ],
  },
  {
    material: "Hierro dúctil", E: 169e9, label: "Hierro ductil — ISO 2531",
    sizes: [
      { label: "DN 80 (3in)", od: 98, classes: [{ name: "K9", e: 6.0 }] },
      { label: "DN 100 (4in)", od: 118, classes: [{ name: "K9", e: 6.0 }] },
      { label: "DN 150 (6in)", od: 170, classes: [{ name: "K9", e: 6.0 }] },
      { label: "DN 200 (8in)", od: 222, classes: [{ name: "K9", e: 6.3 }] },
      { label: "DN 250 (10in)", od: 274, classes: [{ name: "K9", e: 6.8 }] },
      { label: "DN 300 (12in)", od: 326, classes: [{ name: "K9", e: 7.2 }] },
      { label: "DN 350 (14in)", od: 378, classes: [{ name: "K9", e: 7.7 }] },
      { label: "DN 400 (16in)", od: 429, classes: [{ name: "K9", e: 8.1 }] },
      { label: "DN 450 (18in)", od: 480, classes: [{ name: "K9", e: 8.6 }] },
      { label: "DN 500 (20in)", od: 532, classes: [{ name: "K9", e: 9.0 }] },
      { label: "DN 600 (24in)", od: 635, classes: [{ name: "K9", e: 9.9 }] },
    ],
  },
  {
    material: "Acero", E: 210e9, label: "Acero — AWWA C200",
    sizes: [
      { label: '2"', od: 60.3, classes: [{ name: "Sch 20", e: 2.8 }, { name: "Sch 40", e: 3.9 }] },
      { label: '3"', od: 88.9, classes: [{ name: "Sch 20", e: 3.0 }, { name: "Sch 40", e: 5.5 }] },
      ...
      { label: '10"', od: 273.0, classes: [{ name: "Sch 20", e: 5.2 }, { name: "Sch 40", e: 9.3 }] },
      { label: '12"', od: 323.9, classes: [{ name: "Sch 20", e: 6.4 }, { name: "Sch 40", e: 10.3 }] },
      { label: '14"', od: 355.6, classes: [{ name: "Sch 20", e: 6.4 }, { name: "Sch 40", e: 11.1 }] },
      { label: '16"', od: 406.4, classes: [{ name: "Sch 20", e: 6.4 }, { name: "Sch 40", e: 12.7 }] },
      { label: '18"', od: 457.2, classes: [{ name: "Sch 20", e: 6.4 }, { name: "Sch 40", e: 14.3 }] },
      { label: '20"', od: 508.0, classes: [{ name: "Sch 20", e: 6.4 }, { name: "Sch 40", e: 15.1 }] },
