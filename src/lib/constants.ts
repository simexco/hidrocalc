...
export const PIPE_CATALOG: PipeCatalogGroup[] = [
  ...
  },
  {
    ...
    sizes: [
      { label: '2" (OD 63mm)', od: 63, classes: [{ name: "SDR 26", e: 2.5 }, { name: "SDR 17", e: 3.8 }, { name: "SDR 13.6", e: 4.7 }] },
      { label: '2.5" (OD 75mm)', od: 75, classes: [{ name: "SDR 26", e: 3.0 }, { name: "SDR 17", e: 4.5 }, { name: "SDR 13.6", e: 5.6 }] },
      { label: '3" (OD 90mm)', od: 90, classes: [{ name: "SDR 26", e: 3.5 }, { name: "SDR 17", e: 5.4 }, { name: "SDR 13.6", e: 6.7 }] },
      { label: '4" (OD 110mm)', od: 110, classes: [{ name: "SDR 26", e: 4.3 }, { name: "SDR 17", e: 6.6 }, { name: "SDR 13.6", e: 8.1 }] },
      { label: '6" (OD 160mm)', od: 160, classes: [{ name: "SDR 26", e: 6.2 }, { name: "SDR 17", e: 9.5 }, { name: "SDR 13.6", e: 11.8 }] },
      { label: '8" (OD 200mm)', od: 200, classes: [{ name: "SDR 26", e: 7.7 }, { name: "SDR 17", e: 11.9 }, { name: "SDR 13.6", e: 14.8 }] },
      { label: '10" (OD 250mm)', od: 250, classes: [{ name: "SDR 26", e: 9.7 }, { name: "SDR 17", e: 14.8 }, { name: "SDR 13.6", e: 18.5 }] },
      { label: '12" (OD 315mm)', od: 315, classes: [{ name: "SDR 26", e: 12.2 }, { name: "SDR 17", e: 18.7 }, { name: "SDR 13.6", e: 23.2 }] },
      { label: '16" (OD 400mm)', od: 400, classes: [{ name: "SDR 26", e: 15.4 }, { name: "SDR 17", e: 23.5 }, { name: "SDR 13.6", e: 29.4 }] },
      { label: '20" (OD 500mm)', od: 500, classes: [{ name: "SDR 26", e: 19.2 }, { name: "SDR 17", e: 29.4 }, { name: "SDR 13.6", e: 36.8 }] },
      { label: '24" (OD 630mm)', od: 630, classes: [{ name: "SDR 26", e: 24.2 }, { name: "SDR 17", e: 37.1 }, { name: "SDR 13.6", e: 46.3 }] },
    ],
  },
  {
  ...
  },
  {
    ...
    sizes: [
      { label: '2"', od: 60.3, classes: [{ name: "SDR 17", e: 3.5 }, { name: "SDR 11", e: 5.5 }, { name: "SDR 9", e: 6.7 }] },
      { label: '3"', od: 88.9, classes: [{ name: "SDR 17", e: 5.2 }, { name: "SDR 11", e: 8.1 }, { name: "SDR 9", e: 9.9 }] },
      { label: '4"', od: 114.3, classes: [{ name: "SDR 17", e: 6.7 }, { name: "SDR 11", e: 10.4 }, { name: "SDR 9", e: 12.7 }] },
      { label: '6"', od: 168.3, classes: [{ name: "SDR 17", e: 9.9 }, { name: "SDR 11", e: 15.3 }, { name: "SDR 9", e: 18.7 }] },
      { label: '8"', od: 219.1, classes: [{ name: "SDR 17", e: 12.9 }, { name: "SDR 11", e: 19.9 }, { name: "SDR 9", e: 24.3 }] },
      { label: '10"', od: 273.0, classes: [{ name: "SDR 17", e: 16.1 }, { name: "SDR 11", e: 24.8 }, { name: "SDR 9", e: 30.3 }] },
      { label: '12"', od: 323.9, classes: [{ name: "SDR 17", e: 19.1 }, { name: "SDR 11", e: 29.4 }, { name: "SDR 9", e: 36.0 }] },
      { label: '14"', od: 355.6, classes: [{ name: "SDR 17", e: 20.9 }, { name: "SDR 11", e: 32.3 }, { name: "SDR 9", e: 39.5 }] },
      { label: '16"', od: 406.4, classes: [{ name: "SDR 17", e: 23.9 }, { name: "SDR 11", e: 36.9 }, { name: "SDR 9", e: 45.2 }] },
      { label: '18"', od: 457.2, classes: [{ name: "SDR 17", e: 26.9 }, { name: "SDR 11", e: 41.6 }, { name: "SDR 9", e: 50.8 }] },
      { label: '20"', od: 508.0, classes: [{ name: "SDR 17", e: 29.9 }, { name: "SDR 11", e: 46.2 }, { name: "SDR 9", e: 56.4 }] },
      { label: '24"', od: 609.6, classes: [{ name: "SDR 17", e: 35.9 }, { name: "SDR 11", e: 55.4 }, { name: "SDR 9", e: 67.7 }] },
    ],
  },
  {
