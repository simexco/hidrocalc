...
export const PIPE_CATALOG: PipeCatalogGroup[] = [
  ...
  },
  {
    ...
    sizes: [
      { label: '2" (OD 63mm)', od: 63, classes: [{ name: "SDR 17", e: 3.8 }, { name: "SDR 11", e: 5.8 }] },
      { label: '2.5" (OD 75mm)', od: 75, classes: [{ name: "SDR 17", e: 4.5 }, { name: "SDR 11", e: 6.8 }] },
      { label: '3" (OD 90mm)', od: 90, classes: [{ name: "SDR 17", e: 5.4 }, { name: "SDR 11", e: 8.2 }] },
      { label: '4" (OD 110mm)', od: 110, classes: [{ name: "SDR 17", e: 6.6 }, { name: "SDR 11", e: 10.0 }] },
      { label: '6" (OD 160mm)', od: 160, classes: [{ name: "SDR 17", e: 9.5 }, { name: "SDR 11", e: 14.6 }] },
      { label: '8" (OD 200mm)', od: 200, classes: [{ name: "SDR 17", e: 11.9 }, { name: "SDR 11", e: 18.2 }] },
      { label: '10" (OD 250mm)', od: 250, classes: [{ name: "SDR 17", e: 14.8 }, { name: "SDR 11", e: 22.7 }] },
      { label: '12" (OD 315mm)', od: 315, classes: [{ name: "SDR 17", e: 18.7 }, { name: "SDR 11", e: 28.6 }] },
      { label: '14" (OD 355mm)', od: 355, classes: [{ name: "SDR 17", e: 20.9 }, { name: "SDR 11", e: 32.3 }] },
      { label: '16" (OD 400mm)', od: 400, classes: [{ name: "SDR 17", e: 23.7 }, { name: "SDR 11", e: 36.4 }] },
      { label: '18" (OD 450mm)', od: 450, classes: [{ name: "SDR 17", e: 26.5 }, { name: "SDR 11", e: 40.9 }] },
      { label: '20" (OD 500mm)', od: 500, classes: [{ name: "SDR 17", e: 29.4 }, { name: "SDR 11", e: 45.5 }] },
      { label: '24" (OD 630mm)', od: 630, classes: [{ name: "SDR 17", e: 37.1 }, { name: "SDR 11", e: 57.3 }] },
    ],
  },
  {
