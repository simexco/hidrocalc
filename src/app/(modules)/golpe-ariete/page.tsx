        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 space-y-4">
            ...
            {inputs.V0 != null && inputs.V0 > 2.5 && (() => {
              ...
              return (
                <div className="rounded-lg border border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/20 px-3 py-2 text-[11px] text-amber-700 dark:text-amber-300 leading-relaxed">
                  {"⚠"} Velocidad alta: <strong>{formatNumber(inputs.V0, 2)} m/s</strong> (recomendable {"≤"} 2 m/s). El diametro es chico para este caudal.
                  {dSug != null && <> Sube a un diametro interno {"≥"} <strong>{dSug} mm</strong>.</>}
                </div>
              );
            })()}
